 ...
 const sendFormDataToServer = async (formData) => {
  ...
  return (
    ...
    <div className='bg-custom-green min-h-screen flex flex-wrap justify-center items-center'>
      ...
      <form onSubmit                                                                      = {formik.handleSubmit} onReset={formik.handleReset} {...initialvalues} className='flex flex-wrap  justify-center md:justify-start items-center '>
      <div className                                                                            = "form-group mb-2 mx-auto md:mx-0   md:me-8 md:w-1/3">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='name' name='name' placeholder='  Name' value={formik.values.name} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>
     
      <div className                                                                            = "form-group mb-2 mx-auto md:-mx-4  md:w-1/3">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='company' name='company' placeholder='  Company' value={formik.values.company} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>
      ...
      <div className                                                                            = "form-group mb-2 md:w-5/6">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 md:w-5/6 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='website' name='website' placeholder='  website or social media link' value={formik.values.website} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>
     
      <div className                                                                            = "form-group mb-2 mx-auto md:mx-0   md:me-8 md:w-1/3">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='phone' name='phone' placeholder='  Phone' value={formik.values.phone} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>
      
      <div className                                                                            = "form-group mb-2 mx-auto md:-mx-4  md:w-1/3">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='email' name='email' placeholder='  Email' value={formik.values.email} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>

      <div className                                                                            = "form-group mb-2 md:w-5/6">
        {/* <label htmlFor                                                                              = "name" className={`fw-semibold text-uppercase `}>Name *</label> */}
        <input type                                                                                 = "text" className={`form-control form-control-sm p-2 md:w-5/6 bg-transparent border text-custom-gold border-custom-gold  rounded-lg`}  id='subject' name='subject' placeholder='  Service type' value={formik.values.subject} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>

      <div className                                                                              = "form-group mb-3  md:w-5/6">
        {/* <label htmlFor                                                                              = "notes" className={`fw-semibold text-uppercase ${styles.labelText}`}>{t("NoteAboutTheVisitor")}</label> */}
        <textarea rows                                                                              = "4" cols="48" className={`form-control form-control-sm py-2 bg-transparent border text-custom-gold border-custom-gold  rounded-lg resize-none`}  id='message'name='message' value={formik.values.message} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
      </div>
