    ...
    <header className="bg-nav-green text-white   " >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#" className="text-sm font-semibold leading-6 text-custom-cafe hover:text-custom-gold">
          Home
          </a>
          <a href="#" className="text-sm font-semibold leading-6 text-custom-cafe hover:text-custom-gold">
            About
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="hidden text-sm font-semibold leading-6 text-custom-cafe hover:text-custom-gold">
