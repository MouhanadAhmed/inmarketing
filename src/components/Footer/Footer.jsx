  ...
  return (
    ...
    <div className='bg-footer-green pt-24 mx-auto'>
        <div className="md:flex flex-wrap justify-center items-center w-4/6 mx-auto">
            <div className="flex flex-col justify-center items-center  text-start md:w-1/2 mb-8 md:mx-0">
                ...
                <a href="https://www.instagram.com/in.mktg.ag?igsh=MWt1M2U5OTY0YWxrbQ==" target='blank'><i className="fa-brands fa-instagram fa-2xl pt-4 text-custom-gold"></i></a> 
            ...
            <div className="md:w-1/2 mb-8">
                ...
                <div className={`${styles.newsletter} mb-4  ms-auto`}>
        ...
        <div className='bg-black md:flex flex-wrap justify-center items-center md:px-10 text-white'>
            <p className=' md:text-start md:me-14'>© Copyright 2023 By WTS Network</p>
            <img src={logo} alt="IN Marketing logo"  className='md:w-16 md:me-28'/>
